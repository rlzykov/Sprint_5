...
class MainPageLocators:
    ...
    sauces_ul = (By.XPATH,
                 ".//span[(@class = 'text text_type_main-default' and text()='Соусы')]/parent::div")  # Выбор соусов
    # на главной странице
    bun = (By.XPATH, ".//h2[text() = 'Булки']")  # Текст булки на главной странице
    bun_ul = (By.XPATH,
              ".//span[(@class = 'text text_type_main-default' and text()='Булки')]/parent::div")  # Выбор булок на
    # главной странице
    topping = (By.XPATH, ".//h2[text() = 'Начинки']")  # Текст начинки на главной странице
    topping_ul = (By.XPATH,
                  ".//span[(@class = 'text text_type_main-default' and text()='Начинки')]/parent::div")  # Выбор
    # начинок на главной странице
...
class RegistrationPageLocators:
    ...
    password_input = (By.XPATH, ".//label[text()='Пароль']/following-sibling::input[@name='Пароль']")  # Поле ввода
    # пароля
